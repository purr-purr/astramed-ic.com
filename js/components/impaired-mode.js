$(document).ready(function () {
	...
	function load() {
			if (localStorage.getItem("whatIsThame") == 'white-thame') {
					getColorTheme = localStorage.whatIsThame;
					body.addClass(getColorTheme);
			}
			if (localStorage.getItem("whatIsThame") == 'dark-thame') {
					getColorTheme = localStorage.whatIsThame;
					body.addClass(getColorTheme);
			}
